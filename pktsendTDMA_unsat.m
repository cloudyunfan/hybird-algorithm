function [ pl,ps,outcome,CHN_sta_f,Succ_TX_ind,E_ex,E_nodebuf,B_nodebuf,statelast,isgood] = pktsendTDMA_unsat( CHNbefore_leng,CHNafter_leng,CHN_sta_ini,slotNO,Pu,Pd,statelast,isgood,badstatelast,goodstatelast,E_nodebuf,B_nodebuf )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Input:
